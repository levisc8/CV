...
\textbf{Levin SC}, Compagnoni AC, Salguero-Gomez R, Childs DZ, Evers
S\(^\ast\) \& Knight TM (\emph{in review} at \emph{Methods in Ecology
and Evolution}). ipmr: Flexibly implement Integral Projection Models in
R.
